      ...
      bottomNavigationBar: Container(
          ...
          boxShadow: [
            BoxShadow(
              color: Colors.black.withOpacity(
                0.04,
              ), // Bayangan sangat halus seperti di Figma
              blurRadius: 10,
        ...
        child: BottomNavigationBar(
          ...
          type: BottomNavigationBarType
              .fixed, // Wajib fixed agar jaraknya rapi dan label tidak hilang
          ...
          elevation:
              0, // Matikan elevation bawaan karena sudah pakai Container shadow
          items: const [
